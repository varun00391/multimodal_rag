    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-brand-900 to-slate-900 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900">MultiModal RAG</h1>
          <p className="mt-2 text-sm text-slate-500">
            Ask natural-language questions against your PDF documents with grounded evidence.
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          Your account must be provisioned by an administrator before first access.
        </p>
      </div>
    </div>
  )
