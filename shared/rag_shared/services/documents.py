...
from rag_shared.models.entities import Department, Document, DocumentElement, IngestionJob
from rag_shared.models.enums import DocumentStatus, IngestionJobStatus
from rag_shared.schemas.api import DocumentElementResponse, DocumentResponse, IngestionJobResponse
...
async def delete_document(db: AsyncSession, current: CurrentUser, document_id: str) -> None:
    ...
    from rag_shared.schemas.internal import IndexDeleteRequest
    ...
    await client.delete_index(IndexDeleteRequest(document_id=document_id))
